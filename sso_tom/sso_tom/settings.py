...
Generated by ./manage.py tom_setup on Jan. 20, 2024, 2:17 a.m.
...
# ALLOWED_HOSTS = ['.localhost', '127.0.0.1', '[::1]', '10.0.0.24'] # for mobile tests
ALLOWED_HOSTS = []
...
WSGI_APPLICATION = "sso_tom.wsgi.application"
